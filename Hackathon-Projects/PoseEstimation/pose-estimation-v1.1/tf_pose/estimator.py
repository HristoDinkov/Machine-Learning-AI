        ...
        if num_hum>0:
            for human_id in range(1):
                ...
                try:
                    ...
                    difference_x = 0.50 - float(pafprocess.get_part_x(c_idx)) / heat_mat.shape[1]
                    difference_y = 0.50 - float(pafprocess.get_part_y(c_idx)) / heat_mat.shape[0]
                    c_idx = int(pafprocess.get_part_cid(human_id, 5))
                    shoulder_1 = float(pafprocess.get_part_x(c_idx)) / heat_mat.shape[1]
                    c_idx = int(pafprocess.get_part_cid(human_id, 2))
                    shoulder_2 = float(pafprocess.get_part_x(c_idx)) / heat_mat.shape[1]
                ...
                for part_idx in range(18):
                    ...
                    x_idx_part = ((float(pafprocess.get_part_x(c_idx)) / heat_mat.shape[1]) + difference_x-0.50)*prop_coeff+0.50
                    y_idx_part = ((float(pafprocess.get_part_y(c_idx)) / heat_mat.shape[0]) + difference_y-0.50)*prop_coeff+0.50
